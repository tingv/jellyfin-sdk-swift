...
open class PlaystateAPI {
     ...
     */
    open class func markPlayedItem( userId: String,  itemId: String,  datePlayed: Date? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<UserItemDataDto> {
    ...
    /**
     ...
     - returns: Promise<UserItemDataDto>
     */
    open class func markUnplayedItem( userId: String,  itemId: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<UserItemDataDto> {
        let deferred = Promise<UserItemDataDto>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func onPlaybackStopped( userId: String,  itemId: String,  mediaSourceId: String? = nil,  nextMediaType: String? = nil,  positionTicks: Int64? = nil,  liveStreamId: String? = nil,  playSessionId: String? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func pingPlaybackSession( playSessionId: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func reportPlaybackProgress( playbackProgressInfo: PlaybackProgressInfo? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func reportPlaybackStart( playbackStartInfo: PlaybackStartInfo? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func reportPlaybackStopped( playbackStopInfo: PlaybackStopInfo? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
