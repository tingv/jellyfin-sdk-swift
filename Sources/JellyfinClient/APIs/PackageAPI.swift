...
open class PackageAPI {
     ...
     */
    open class func cancelPackageInstallation( packageId: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
     ...
     */
    open class func getPackageInfo( name: String,  assemblyGuid: String? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<PackageInfo> {
    ...
    /**
     ...
     - returns: Promise<[PackageInfo]>
     */
    open class func getPackages(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[PackageInfo]> {
        let deferred = Promise<[PackageInfo]>.pending()
     ...
     */
    open class func getRepositories(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[RepositoryInfo]> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func installPackage( name: String,  assemblyGuid: String? = nil,  version: String? = nil,  repositoryUrl: String? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func setRepositories( repositoryInfo: [RepositoryInfo], apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
