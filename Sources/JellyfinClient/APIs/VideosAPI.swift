...
open class VideosAPI {
     ...
     */
    open class func deleteAlternateSources( itemId: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
     ...
     */
    open class func getAdditionalPart( itemId: String,  userId: String? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<BaseItemDtoQueryResult> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func mergeVersions( ids: [String], apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
