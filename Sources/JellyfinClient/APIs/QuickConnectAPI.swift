...
open class QuickConnectAPI {
     ...
     */
    open class func activate(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
     ...
     */
    open class func authorize( code: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Bool> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func available( status: QuickConnectState? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
     ...
     */
    open class func connect( secret: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<QuickConnectResult> {
    ...
    /**
     ...
     - returns: Promise<Int>
     */
    open class func deauthorize(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Int> {
     ...
     */
    open class func getStatus(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<QuickConnectState> {
    ...
    /**
     ...
     - returns: Promise<QuickConnectResult>
     */
    open class func initiate(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<QuickConnectResult> {
        let deferred = Promise<QuickConnectResult>.pending()
