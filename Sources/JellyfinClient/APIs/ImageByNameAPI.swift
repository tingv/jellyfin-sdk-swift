...
open class ImageByNameAPI {
    /**
     ...
     - returns: Promise<URL>
     */
    open class func getGeneralImage( name: String,  type: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<URL> {
     ...
     */
    open class func getGeneralImages(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[ImageByNameInfo]> {
    ...
    /**
     ...
     - returns: Promise<URL>
     */
    open class func getMediaInfoImage( theme: String,  name: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<URL> {
        let deferred = Promise<URL>.pending()
    ...
    /**
     ...
     - returns: Promise<[ImageByNameInfo]>
     */
    open class func getMediaInfoImages(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[ImageByNameInfo]> {
        let deferred = Promise<[ImageByNameInfo]>.pending()
    ...
    /**
     ...
     - returns: Promise<URL>
     */
    open class func getRatingImage( theme: String,  name: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<URL> {
        let deferred = Promise<URL>.pending()
    ...
    /**
     ...
     - returns: Promise<[ImageByNameInfo]>
     */
    open class func getRatingImages(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[ImageByNameInfo]> {
        let deferred = Promise<[ImageByNameInfo]>.pending()
