...
open class SystemAPI {
     ...
     */
    open class func getEndpointInfo(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<EndPointInfo> {
    ...
    /**
     ...
     - returns: Promise<URL>
     */
    open class func getLogFile( name: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<URL> {
     ...
     */
    open class func getPingSystem(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<String> {
     ...
     */
    open class func getPublicSystemInfo(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<PublicSystemInfo> {
     ...
     */
    open class func getServerLogs(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[LogFile]> {
     ...
     */
    open class func getSystemInfo(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<SystemInfo> {
     ...
     */
    open class func getWakeOnLanInfo(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[WakeOnLanInfo]> {
    ...
    /**
     ...
     - returns: Promise<String>
     */
    open class func postPingSystem(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<String> {
        let deferred = Promise<String>.pending()
     ...
     */
    open class func restartApplication(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
    ...
    /**
     ...
     - returns: Promise<Void>
     */
    open class func shutdownApplication(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
        let deferred = Promise<Void>.pending()
