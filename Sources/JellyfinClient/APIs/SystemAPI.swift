...
open class SystemAPI {
    ...
    open class func getEndpointInfo(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<EndPointInfo, Error> {
    ...
    open class func getEndpointInfoWithRequestBuilder() -> RequestBuilder<EndPointInfo> {
        ...
        let requestBuilder: RequestBuilder<EndPointInfo>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getLogFile(name: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<URL, Error> {
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getPingSystem(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<String, Error> {
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getPublicSystemInfo(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<PublicSystemInfo, Error> {
    ...
    open class func getPublicSystemInfoWithRequestBuilder() -> RequestBuilder<PublicSystemInfo> {
        ...
        let requestBuilder: RequestBuilder<PublicSystemInfo>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getServerLogs(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<[LogFile], Error> {
    ...
    open class func getServerLogsWithRequestBuilder() -> RequestBuilder<[LogFile]> {
        ...
        let requestBuilder: RequestBuilder<[LogFile]>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getSystemInfo(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<SystemInfo, Error> {
    ...
    open class func getSystemInfoWithRequestBuilder() -> RequestBuilder<SystemInfo> {
        ...
        let requestBuilder: RequestBuilder<SystemInfo>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getWakeOnLanInfo(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<[WakeOnLanInfo], Error> {
    ...
    open class func getWakeOnLanInfoWithRequestBuilder() -> RequestBuilder<[WakeOnLanInfo]> {
        ...
        let requestBuilder: RequestBuilder<[WakeOnLanInfo]>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func postPingSystem(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<String, Error> {
        return Future<String, Error>.init { promise in
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func restartApplication(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<Void, Error> {
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func shutdownApplication(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<Void, Error> {
        return Future<Void, Error>.init { promise in
