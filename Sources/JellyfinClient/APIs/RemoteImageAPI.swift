...
open class RemoteImageAPI {
     ...
     */
    open class func downloadRemoteImage( itemId: String,  type: ImageType,  imageUrl: String? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
     ...
     */
    open class func getRemoteImageProviders( itemId: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[ImageProviderInfo]> {
     ...
     */
    open class func getRemoteImages( itemId: String,  type: ImageType? = nil,  startIndex: Int? = nil,  limit: Int? = nil,  providerName: String? = nil,  includeAllLanguages: Bool? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<RemoteImageResult> {
