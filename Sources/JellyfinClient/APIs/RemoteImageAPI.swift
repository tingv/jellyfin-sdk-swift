...
open class RemoteImageAPI {
    ...
    open class func downloadRemoteImage(itemId: String, type: ImageType, imageUrl: String? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<Void, Error> {
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getRemoteImageProviders(itemId: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<[ImageProviderInfo], Error> {
    ...
    open class func getRemoteImageProvidersWithRequestBuilder(itemId: String) -> RequestBuilder<[ImageProviderInfo]> {
        ...
        let requestBuilder: RequestBuilder<[ImageProviderInfo]>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getRemoteImages(itemId: String, type: ImageType? = nil, startIndex: Int? = nil, limit: Int? = nil, providerName: String? = nil, includeAllLanguages: Bool? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<RemoteImageResult, Error> {
    ...
    open class func getRemoteImagesWithRequestBuilder(itemId: String, type: ImageType? = nil, startIndex: Int? = nil, limit: Int? = nil, providerName: String? = nil, includeAllLanguages: Bool? = nil) -> RequestBuilder<RemoteImageResult> {
        ...
        let requestBuilder: RequestBuilder<RemoteImageResult>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
