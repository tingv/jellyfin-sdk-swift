...
open class EnvironmentAPI {
    ...
    open class func getDefaultDirectoryBrowser(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<DefaultDirectoryBrowserInfoDto, Error> {
    ...
    open class func getDefaultDirectoryBrowserWithRequestBuilder() -> RequestBuilder<DefaultDirectoryBrowserInfoDto> {
        ...
        let requestBuilder: RequestBuilder<DefaultDirectoryBrowserInfoDto>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getDirectoryContents(path: String, includeFiles: Bool? = nil, includeDirectories: Bool? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<[FileSystemEntryInfo], Error> {
    ...
    open class func getDirectoryContentsWithRequestBuilder(path: String, includeFiles: Bool? = nil, includeDirectories: Bool? = nil) -> RequestBuilder<[FileSystemEntryInfo]> {
        ...
        let requestBuilder: RequestBuilder<[FileSystemEntryInfo]>.Type = JellyfinClient.requestBuilderFactory.getBuilder()
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getDrives(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<[FileSystemEntryInfo], Error> {
        return Future<[FileSystemEntryInfo], Error>.init { promise in
    ...
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getNetworkShares(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<[FileSystemEntryInfo], Error> {
        return Future<[FileSystemEntryInfo], Error>.init { promise in
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getParentPath(path: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<String, Error> {
    ...
    #if canImport(Combine)
    @available(OSX 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func validatePath(validatePathDto: ValidatePathDto, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> AnyPublisher<Void, Error> {
