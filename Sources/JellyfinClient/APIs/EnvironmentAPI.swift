...
open class EnvironmentAPI {
     ...
     */
    open class func getDefaultDirectoryBrowser(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<DefaultDirectoryBrowserInfoDto> {
     ...
     */
    open class func getDirectoryContents( path: String,  includeFiles: Bool? = nil,  includeDirectories: Bool? = nil, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[FileSystemEntryInfo]> {
    ...
    /**
     ...
     - returns: Promise<[FileSystemEntryInfo]>
     */
    open class func getDrives(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[FileSystemEntryInfo]> {
        let deferred = Promise<[FileSystemEntryInfo]>.pending()
    ...
    open class func getNetworkShares(apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<[FileSystemEntryInfo]> {
        let deferred = Promise<[FileSystemEntryInfo]>.pending()
     ...
     */
    open class func getParentPath( path: String, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<String> {
     ...
     */
    open class func validatePath( validatePathDto: ValidatePathDto, apiResponseQueue: DispatchQueue = JellyfinClient.apiResponseQueue) -> Promise<Void> {
